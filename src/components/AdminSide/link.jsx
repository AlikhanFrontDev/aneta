...
export default function Link() {
  ...
  const submitHandler = (e) => {
    ...
    axios
      .post(Endpoint + `v1/link/createTopic/?name=${name}`, postData, {
  ...
  const submitHandler2 = (e) => {
    ...
    axios
      .post(
        Endpoint + `v1/link/add-link/${topicId}/`,
        postData,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(Endpoint + "v1/link/allTopic", {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const deleteRequestHandler = async (id) => {
    ...
    const response = await axios.delete(
      Endpoint + `v1/link/deleteTopic/${id}`,
  ...
  const deleteRequestHandler2 = async (id, fileid) => {
    ...
    const token = JSON.parse(localStorage.getItem("token"));
    const response = await axios.delete(
      Endpoint + `v1/link/delete-link/${fileid}/${id}`,
                      ...
                      <div className="detailes">
                        ...
                        <div className="buttons">
                          <p
                            className="delete"
                            onClick={() =>
                              deleteRequestHandler2(topic.id, item.id)
                            }
                          >
                            delete
                          </p>
